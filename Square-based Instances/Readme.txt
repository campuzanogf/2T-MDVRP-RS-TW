...
The instance names start with the letter "S", meaning "square instance". Then, it comes 4 numbers separated by a dash "-". The first number tells the number of depots in the instance.
